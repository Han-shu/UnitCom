...
df = DataFrame(Gen = [], pg_min = [], pg_max = [], fixed_cost = [], startup_cost = [], variable_cost = [], minup = [], mindown = [], time_limits = [], commitment = [])
for g in thermal_gen_names
    ...
    push!(df, [g, pg_lim[g].min, pg_lim[g].max, fixed_cost[g], startup_cost[g], variable_cost[g], time_limits[g].up, time_limits[g].down, time_limits[g].down, commit_status])
end
